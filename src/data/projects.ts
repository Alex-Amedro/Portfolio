...
export const projects: Project[] = [
  {
    ...
    titleFr: 'Projet Ariadne - Génération Adaptative de Niveaux',
    titleZh: 'Ariadne项目 - 自适应关卡生成',
    descriptionEn: 'ML research project combining RL and GANs for procedural content generation in Doom.',
    descriptionFr: 'Projet de recherche ML combinant RL et GANs pour la génération procédurale dans Doom.',
    descriptionZh: 'ML研究项目，结合RL和GAN用于Doom中的程序化内容生成。',
    fullDescriptionEn: ``,
    fullDescriptionFr: ``,
    fullDescriptionZh: ``,
    challengeEn: ``,
    ...
    learningsFr: ``,
    learningsZh: ``,
    stack: ['PyTorch', 'Python', 'ViZDoom', 'NumPy', 'OpenCV'],
    image: '/projects/ariadne/doom.jpeg',
    images: [],
    liveUrl: '',
    githubUrl: 'https://github.com/Alex-Amedro/ariadne',
...
软技能： 算法问题解决、自主学习、调试、迭代开发。`,
    ...
    liveUrl: '',
    githubUrl: 'https://github.com/Alex-Amedro/Rayt',
...
- 注重细节：微调游戏感觉和响应性、创建连贯的视觉反馈、平衡游戏机制`,
    ...
    liveUrl: '',
    githubUrl: 'https://github.com/Alex-Amedro/Heracles-',
    status: 'completed' as const,
    date: '2025-05',
    featured: true,
  },
